...
<h2>Our Discovery</h2>
<p>Teachers struggle to manage the demands of monitoring students’ coursework,
from tracking students’ progress to ensuring that they provide quality
feedback to students.
<br>
<br>Many students lack initiative to self-manage their progress and are dependent
on teachers to “chase them”.</p>
<hr>
<h2>Our Innovation</h2>
<p><strong>ProjecTask</strong> consists of a set of ProjecTask boards that
can be used&nbsp;<strong>independently</strong>&nbsp;or together with a&nbsp;<strong>complementary</strong>&nbsp;SLS
lesson template:</p>
<div class="isomer-image-wrapper">
<img style="width: 100%" height="auto" width="100%" alt="" src="/images/ProjecTask/What_is_ProjecTask.png">
</div>
<p><strong>ProjecTask</strong> enables both teachers and students to manage
and monitor project work progress more efficiently and effectively by providing:</p>
<div class="isomer-image-wrapper">
<img style="width: 100%" height="auto" width="100%" alt="" src="/images/ProjecTask/ProjecTask_features_new_2.png">
</div>
<p>
<br>
<br>
